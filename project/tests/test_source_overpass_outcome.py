...
def test_genuinely_empty_sweep_still_halts_loudly():
    """Cities were searched, nothing came back at all, nothing was skipped —
    that IS anomalous and must still abort."""
