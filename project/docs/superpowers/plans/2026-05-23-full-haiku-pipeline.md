...
```bash
mkdir -p <home>/Desktop/lead-outreach-system/project/tests
touch <home>/Desktop/lead-outreach-system/project/tests/__init__.py
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tests/
git -C <home>/Desktop/lead-outreach-system/project commit -m "test: add merge_candidates tests"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tools/scripts/merge_candidates.py
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: add merge_candidates.py (Stage 3)"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tests/test_persist_sent_log.py
git -C <home>/Desktop/lead-outreach-system/project commit -m "test: add persist_sent_log tests"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tools/scripts/persist_sent_log.py
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: add persist_sent_log.py (Stage 8)"
```
...
```bash
chmod +x <home>/Desktop/lead-outreach-system/project/tools/scripts/fetch_html.sh
```
...
bash <home>/Desktop/lead-outreach-system/project/tools/scripts/fetch_html.sh test_fetch
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tools/scripts/fetch_html.sh
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: add fetch_html.sh (Stage 4)"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tools/scripts/extract_leads.py
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: refactor extract_leads.py to tools/scripts/ with --run-dir"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tools/scripts/draft_emails.py
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: refactor draft_emails.py to tools/scripts/ with --run-dir"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add tools/scripts/send.py
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: refactor send.py to tools/scripts/ with --run-dir"
```
...
```bash
mkdir -p <home>/Desktop/lead-outreach-system/project/agents
```
...
```bash
wc -l <home>/Desktop/lead-outreach-system/project/agents/source-agent.md
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add agents/source-agent.md
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: add agents/source-agent.md (Haiku sourcing memory)"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add agents/run-kickoff.md
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: add agents/run-kickoff.md (orchestrator memory)"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add PIPELINE.md
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: add PIPELINE.md (master pipeline contract)"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add CLAUDE.md runs/run-config-template.md
git -C <home>/Desktop/lead-outreach-system/project commit -m "feat: update CLAUDE.md + add run-config template"
```
...
```bash
git -C <home>/Desktop/lead-outreach-system/project add -A
git -C <home>/Desktop/lead-outreach-system/project commit -m "chore: full-haiku pipeline complete — all stages portable, agents wired"
```
