...
> Offer (2026-08-26): time-capture / billing-leakage agent for hourly-billing
> firms; medical-records agent for PI firms. FIXED copy: `pitch.json` (1A/1B).
> **Vertical qualification scope (read before qualifying leads):**
> `vault/lead-outreach/targeting/us-law-firms-scope.md` — regions, sub-segments,
