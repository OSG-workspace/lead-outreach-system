...
> Offer (2026-08-26): consult-conversion / 48-hour nurture agent for
> multi-location med spa / dental groups. FIXED copy: `pitch.json`.
> **Vertical qualification scope (read before qualifying leads):**
> `vault/lead-outreach/targeting/us-clinics-scope.md` — regions, sub-segments,
